...
app.use(helmet({
  ...
  contentSecurityPolicy: false /* {
    directives: {
      ...
      connectSrc: ["'self'", "http://192.168.2.13", "https://www.gstatic.com", "https://fonts.gstatic.com"], // Flutter + Backend + Fonts
      frameSrc: ["'none'"],
      objectSrc: ["'none'"],
      // ⚠️ upgradeInsecureRequests EXPLIZIT deaktiviert für PVE Development
      upgradeInsecureRequests: null,
    }
  } */,
  hsts: false, // Komplett deaktiviert für PVE Development
...
const swaggerOptions = {
  ...
  swaggerOptions: {
    ...
    url: '/api-combined.yaml'  // Relative URL - funktioniert mit HTTP und HTTPS!
  }
};
